...
//    $v='203.16.208.231';
//    $v= (!empty($_SERVER['HTTP_X_FORWARDED_FOR']))?$_SERVER['HTTP_X_FORWARDED_FOR'] :((!empty($_SERVER['REMOTE_ADDR'])) ? $_SERVER['REMOTE_ADDR']: @getenv('REMOTE_ADDR'));
